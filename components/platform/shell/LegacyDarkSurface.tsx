...
const RESTYLED = new Set(["/dashboard"]);

/**
 * Transitional. The shell is light (WP44-S2). Home is light too (WP44-S4),
 * but Explore, billing, projects and intake still use dark styles until
 * WP44-S5 and S7 restyle them. This keeps their text readable in the
