...
/**
 * Plan and billing (WP44-S7 and S10, PRD 6.3 and 6.6). Flag off: the Free
 * plan and what it includes. Flag on: the Free against Builder's Hub table
 * from entitlements, with no upgrade button until the subscription work
 * ships. Credit packs stay hidden (R9): `BillingWorkspace` is kept,
 * unrendered, for then.
 */
