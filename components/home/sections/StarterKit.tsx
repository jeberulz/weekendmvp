...
export function StarterKit() {
  return (
    <section id="starter-kit" aria-labelledby="home-kit-title" data-scene="kit" className="relative overflow-hidden bg-home-paper">
      ...
      <Container className="relative flex flex-col gap-7 py-14 lg:gap-9 lg:py-[88px]">
        <div data-m="head" className="flex flex-col gap-3.5 lg:gap-4">
          <Eyebrow>Free Starter Kit</Eyebrow>
          <h2 id="home-kit-title" data-m="lines" className="font-editorial text-[38px] font-normal leading-[1.02] tracking-[-0.025em] text-home-ink lg:text-[60px] lg:leading-[1.06] lg:tracking-[-0.02em]">
            Your ticket to <Em>a shipped weekend.</Em>
          </h2>
        </div>

        <div data-m="kit" className="grid grid-cols-1 drop-shadow-[0_24px_30px_rgba(26,24,20,0.18)] lg:grid-cols-[820px_minmax(0,1fr)] lg:drop-shadow-[0_30px_40px_rgba(26,24,20,0.18)]">
          <div data-m="ticket" className="flex flex-col gap-[26px] rounded-t-3xl bg-home-orange-ink px-[22px] pb-[26px] pt-6 lg:h-[440px] lg:justify-between lg:rounded-l-[28px] lg:rounded-tr-none lg:px-12 lg:py-10">
          ...
          <div aria-hidden data-m="tear" className="relative h-0 border-t-2 border-dashed border-home-rule lg:hidden">
            <span data-m="notch" className="absolute -left-3.5 -top-[15px] size-7 rounded-full bg-home-paper" />
            <span data-m="notch" className="absolute -right-3.5 -top-[15px] size-7 rounded-full bg-home-paper" />
          </div>

          <div data-m="stub" className="relative flex flex-col gap-3 rounded-b-3xl bg-home-card px-[22px] py-6 lg:gap-4 lg:rounded-r-[28px] lg:rounded-bl-none lg:border-l-2 lg:border-dashed lg:border-home-rule lg:px-9 lg:py-10">
            <span aria-hidden data-m="notch" className="absolute -left-[17px] -top-4 hidden size-8 rounded-full bg-home-paper lg:block" />
            <span aria-hidden data-m="notch" className="absolute -bottom-4 -left-[17px] hidden size-8 rounded-full bg-home-paper lg:block" />
            ...
            <div className="flex items-end justify-between gap-4 pt-1.5 lg:mt-auto lg:flex-col lg:items-start">
              ...
              <div aria-hidden data-m="barcode" className="flex items-end gap-0.5">
                {BARS.map((w, i) => (
        ...
        <ul data-m="up-list" className="grid grid-cols-1 gap-3 text-[15px] text-home-ink-2 lg:grid-cols-3 lg:gap-x-7 lg:gap-y-3.5">
