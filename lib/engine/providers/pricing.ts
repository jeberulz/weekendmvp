...
/**
 * Verified against OpenAI's model documentation on 2026-08-07; re-checked
 * 2026-09-24 for Mode A2 M2 (idea-engine phase 4).
 *
 * **There is still no dated snapshot for this model.** Docs list a single ID,
 * `gpt-5.6-sol`, with floating alias `gpt-5.6` routing to it. Pin the concrete
 * ID; never the alias. Re-pin when OpenAI ships a dated snapshot.
 */
