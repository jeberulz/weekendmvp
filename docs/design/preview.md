...
Publish checkout packet. Account menu. Exact preview-host naming and WP31 DNS. How many `DESIGN.md` files and who runs the first compile. Day 1 proposal copy. Own-idea path (v1.1). Coding.
