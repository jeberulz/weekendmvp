...
> **2026-08-14 — signed-in home, chrome, Library, preview customisation, publish packet, and Account are superseded.**
> Do not implement the Hilos dual-rail, dashboard-as-command-center, Saved/Interested-as-nav, home composer, Explore destination views, the `/build/{slug}` CMS, WP29 cockpit as Launch, `/dashboard/billing` as publish or Account, or a settings/profile app behind Account from this brief.
> Home: [`docs/design/signed-in-home.md`](../design/signed-in-home.md). Library: [`docs/design/signed-in-library.md`](../design/signed-in-library.md). Preview: [`docs/design/preview.md`](../design/preview.md). Publish: [`docs/design/publish.md`](../design/publish.md). Account: [`docs/design/account.md`](../design/account.md).
