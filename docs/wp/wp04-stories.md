# WP04 Stories - Publish 5 Programmatic SEO Hubs
...
- [x] `WP04-S1` - Tag ideas + audience ref blocks in `ideas/manifest.json`
...
- [x] `WP04-S2` - Audience hubs: freelancers, creators, small-business-owners
...
- [x] `WP04-S3` - Problem hubs: lead-generation, content-creation
