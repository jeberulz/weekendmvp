...
| WP16 | Weekly validation digest | Work Package | `cursor/weekly-validation-digest-fde5` | In progress | Funnel events, idea validation metadata, thresholded weekly GA4 comparison, report artifact, and configured owner email delivery. |
