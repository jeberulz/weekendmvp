...
| WP03 | Five AEO/SEO articles | Work Package | `cursor/publish-5-articles-aeo-seo-f2aa` | PR open (OG retry pending) | Five net-new articles in MDX + manifest, Convex-seeded (prod), OG failed in cloud (no image API keys), PR open with FAQ-forward AEO structure and CTAs to `/startup-ideas`. |
