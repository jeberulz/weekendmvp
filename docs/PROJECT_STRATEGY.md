...
| WP43 | Ideas-first dashboard (free and paid) | Work Package | `claude/wizardly-rubin-a6m2th` (PRD and plan) | PRD in review — R1–R4 ruled 2026-09-25, R5–R9 pending | `/dashboard` is the light ideas-first home in `docs/wp/wp43-dashboard-prd.md`; free Home, Ideas, Saved and one weekend plan ship; Builder's Hub ($29/mo) UI and entitlements sit behind a flag; standard checks and WCAG 2.1 AA pass. |
