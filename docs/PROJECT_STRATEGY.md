...
| WP22 | Platform schema, state, and authorization | 2 | `codex/wp22-platform-contracts` | Ready | Additive indexed contracts and two-user ownership/state-machine tests are frozen for parallel consumers. |
