...
| WP26 | Durable workflow and Validation Reports | 3 | `codex/wp26-research-workflow` | Stories frozen 2026-08-06; provider/cost/retention rulings recorded; implementation not started | A named report/site-input contract subgate (`WP26-S1`) freezes before parallel renderer work; durable tasks and both report paths then meet retry/refund, evidence, cost, and quality gates. |
