...
| WP21 | Convex Auth compatibility migration | 2 | `codex/wp21-convex-auth` | Resend code/security gate passed; live provider E2E and production blocked | Compatibility foundation and secure Resend wiring are green. Completion requires credential-backed Resend delivery and Google provider E2E; production separately waits for backup, dry run, secrets, and approval. |
