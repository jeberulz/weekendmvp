...
| WP21 | Convex Auth compatibility migration | 2 | `codex/wp21-convex-auth` | Resend selected; provider wiring/E2E in progress; production blocked | Compatibility foundation is green. Completion requires secure Resend wiring plus configured Resend and Google provider E2E; production separately waits for backup, dry run, secrets, and approval. |
