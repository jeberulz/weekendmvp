...
| WP03 | Publish 5 programmatic SEO hubs | Work Package | `cursor/publish-5-programmatic-hubs-8e5e` | In progress | Three audience hubs (`freelancers`, `creators`, `small-business-owners`) + two problem hubs (`lead-generation`, `content-creation`) in config, ideas tagged + seeded, typecheck green, PR open. |
