...
| WP43 | Ideas-first dashboard (free and paid) | Work Package | `claude/wizardly-rubin-a6m2th` (PRD and plan) | Rulings complete (R1–R9, 2026-09-25) — Phase A ready; R5 follow-up on WP29–31 open | `/dashboard` is the light ideas-first home in `docs/wp/wp43-dashboard-prd.md`; free Home, Ideas, Saved and one weekend plan ship; Builder's Hub ($29/mo, monthly only) UI and entitlements sit behind a flag; no site preview, publish or credit entry points (parked for v1.1); standard checks and WCAG 2.1 AA pass. |
