...
| WP23 | Signed-in shell, dashboard, Explore, and intent | 2 | `codex/wp23-platform-explore` | Development complete — code gate passed; authenticated browser pending | Shell/dashboard/Explore and owner-scoped intent pass independent code review; safe signed-in desktop/mobile visual, keyboard, focus, and a11y evidence remains. |
...
| WP25 | Intake, briefs, projects, and public idea bridge | 2 | `codex/wp25-intake-projects` | Development complete — code gate passed; authenticated browser pending | Repository/own-idea intake, versioned briefs/projects, and public CTA pass code review; safe signed-in desktop/mobile autosave/conflict/focus/a11y evidence remains. |
