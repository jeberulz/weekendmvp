...
| WP27 | Structured renderer and isolated preview | 3 | `codex/wp27-site-preview` | Stories frozen 2026-08-06; storage/lifetime/template rulings recorded; implementation not started | Preview is schema-safe, owner/capability-scoped, expiring, non-indexable, and incapable of production lead capture. |
