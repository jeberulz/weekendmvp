...
| WP44 | Ideas-first dashboard (free and paid) | Work Package | `claude/wizardly-rubin-a6m2th` (PRD and plan) | Rulings complete (R1–R9, 2026-09-25) — S2 to S7 done 2026-09-25; Phase A complete, S8 next | `/dashboard` is the light ideas-first home in `docs/wp/wp44-dashboard-prd.md`; free Home, Ideas, Saved and one weekend plan ship; Builder's Hub ($29/mo, monthly only) UI and entitlements sit behind a flag; no site preview, publish or credit entry points (parked for v1.1); standard checks and WCAG 2.1 AA pass. |
...
| WP29 | Project cockpit, revisions, and task refunds | 3 | `codex/wp29-project-cockpit` | **Paused** — site publishing parked for v1.1 (ruling 2026-09-25) | Cockpit + publish UX for repository path; full revision/refund UX deferred to v1.1. |
| WP30 | Trust, safety, abuse controls, and observability | 3 | `codex/wp30-trust-safety` | **Paused** — site publishing parked for v1.1 (ruling 2026-09-25) | v1.0 minimum: manual policy gate, kill switch, rate limits; full classifier corpus deferred. |
...
| WP31 | Production activation, launch surface, and analytics | 4 | `codex/wp31-platform-launch` | **Paused** — site publishing parked for v1.1 (ruling 2026-09-25) | Owner-approved live payment, wildcard, rollback, stranger journey; see revised scope cut for launch bar. |
...
- **Paused 2026-09-25:** site publishing (preview, publish, hosting, tenant sites, credits) is parked for v1.1, so WP29, WP30 and WP31 are paused. Product work leads with ideas (WP42 homepage, WP44 dashboard). The critical path below is kept for when publishing resumes.
