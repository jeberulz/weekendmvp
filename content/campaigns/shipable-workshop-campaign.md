...
| Day | Date | Phase | Profanity | Working subject | The one job |
|----|------|-------|-----------|-----------------|-------------|
| 1 | Mon 6/15 | Belief | CLEAN | the idea you keep not building | Name the pain. No pitch. |
| 2 | Tue 6/16 | Belief | CLEAN | more followers won't fix this | Reframe: one shipped thing, not "more". |
| 3 | Wed 6/17 | **Announce** | MILD | I'm doing something I never do | The announcement. |
| 4 | Thu 6/18 | Objection | MILD | but you're not technical. good. | Kill "I don't code". |
| 5 | Fri 6/19 | Objection | CLEAN | this fits in a Saturday morning | Kill "no time" / scope too big. |
| 6 | Sat 6/20 | Proof | MILD | he sat on it for a year | Case study / story. |
| 7 | Sun 6/21 | Value | CLEAN | nine dollars. here's the math. | Justify the $9 + value stack. |
| 8 | Mon 6/22 | Vision | MILD | what you actually walk out with | Paint the "after". |
| 9 | Tue 6/23 | Objection | MILD | don't have an idea? perfect. | Kill "no idea yet". |
| 10 | Wed 6/24 | Urgency | MILD | [X] builders are already in | Momentum + capped seats. |
| 11 | Thu 6/25 | Emotion | CLEAN | this time next year | Cost of not shipping. |
| 12 | Fri 6/26 | **48-hr** | FULL-SEND | 48 hours, then the doors shut | 48-hour push. |
| 13 | Sat 6/27 | **Day-of** | FULL-SEND | shoulda, woulda, shipped | Final collar-grab. |
| 13b | Sat 6/27 | **Last call** | MILD | we're live in 60 minutes | Optional pre-live blast. |
...
You've had it for a while. Maybe months. Maybe longer.

You've thought about the name. Maybe even bought the domain. You've "researched" it enough to talk about it at dinner.
...
And this week, I'm going to help you do it live.

More on that in a couple of days.

For now, just hit reply and tell me: what's the idea you keep *not* building?
...
**Preview:** You don't need more. You need one shipped thing.

[First Name],

Quick gut-check.

When you think about why your idea isn't real yet, what's the reason?
...
"I need a bigger audience before it's worth it."
"I need to think it through more."

Every one of those feels true.
...
It's one shipped thing.

One small, real, live version of the idea. Out in the world where people can actually use it.
...
**Preview:** One live workshop. $9. You walk out with a real MVP.

Hey [First Name],

I'm doing something I almost never do.

I'm running a live workshop. One time. Open to everyone on this list.
...
Because here's what I've learned after years of building weekend MVPs:
...
If you want in, grab your seat now.

**→ weekendmvp.app/shipable**
...
**Preview:** We build live with AI. No code. Yes, really.
...
Not a mockup. A real link. One they texted to their mates that night.

If "I don't code" has been your reason for a year, Saturday is the morning it stops being a reason.

It's $9. Live on Zoom. Replay if you can't make it.
...
**Preview:** The whole trick is building small enough to actually finish.

[First Name],

The number one reason good ideas die:
...
The fix is the entire philosophy behind Weekend MVP: build the smallest version that proves the idea, and ship *that*. This weekend. Not the dream. The one screen that matters.

On Saturday, that's exactly what we do together:
...
[Name] had an idea for [a simple tool for X]. Had it for about a year.

Not a developer. Not a "founder." Just someone annoyed by a problem enough to imagine a fix.

For twelve months it lived in the Notes app. Every few weeks he'd reopen it, feel the itch, and close it again.

Then he sat down for one session, scoped it to a single screen, built it with AI, and pushed it live that night.

By Monday, [X] people were using it.

Nothing about [Name]'s skill changed that week. Nothing about his audience changed.

The only thing that changed: the idea went from his head to a URL.

That's it. That's the whole unlock.

On Saturday, I want to do that with you. Live. In 90 minutes. For $9.
...
**Preview:** Less than your Sunday coffee. Here's everything inside.
...
**Preview:** Not notes. Not "inspiration." A live link.

[First Name],

Most workshops, you walk out with notes you never open again.

Not this one.

Here's the actual state you're in 90 minutes after we start on Saturday:
...
And you have a **48-hour plan** for the next version, scoped so you can actually finish it.

That's not "inspiration." That's an asset that didn't exist when you woke up.
...
$9, live on Zoom, replay included.
...
**Preview:** Bring yours, or take one of our 78.

[First Name],

A few people have replied with some version of:
...
Quick update: [X] builders have already grabbed a seat for Saturday.

And I want to be straight with you about something.

I'm not running this as a giant faceless webinar where I talk at a wall of 5,000 muted strangers.

I want to actually see screens. Unstick people live. Watch ideas go from "in my head" to "here's the link" in real time.

That kind of interaction only works with a capped room.
...
**Preview:** Same idea, another year older. Or not.

[First Name],

I want to play out two versions of this time next year.
...
**Preview:** Nine bucks. Two days. Then it's gone.
...
If you're reading this, you're already capable of building the thing you keep talking about.

You don't need more time.

And you sure as shit don't need to "learn to code first."

But…

Your idea is still stuck in your head.

And an idea in your head pays exactly fuck all. It just sits there, nagging you every time someone else launches the thing you swore you'd build.
...
It's because you've never sat down and shipped the smallest version of it.

Most people in your shoes keep "getting ready." Researching. Tweaking the plan. Buying another course.

But getting ready doesn't put anything live.

So for 90 minutes on Saturday, you and I are going to fix that. On the call. You'll walk out with a link.

It's nine dollars. Less than the coffee you'll drink while we build.

Live on Zoom, replay's yours if you can't make it. Either way you're covered.
...
Nine bucks. Two days. Then the doors shut.
...
**Preview:** This is me grabbing you by the collar one last time.

I just sent the final reminder to everyone who's in.
...
A little tool for your industry. A tiny SaaS. A directory. A marketplace. An app for the thing only you and 10,000 other people are annoyed by.

Whatever it is.

You know it's worth building.

You've known for a while.

But it's still just sitting there. In your head. Doing fuck-all for you except nagging every time someone else ships the thing you could've built.

That's the actual problem.

Not your skill. Not your tools. Not the fact that you "don't code."

You've just never turned the idea into something a person can open and use.

That's the entire job of these 90 minutes tomorrow.

You show up Saturday, you walk out with a live MVP. One link. Real. Ready to send to your first 5 users this week.
...
The only way you lose here is by nodding along to this email and then doing exactly what you did last time. Sweet nothing.

Don't be the person who emails me tomorrow asking for a seat after the doors closed. We get them every time. Same answer every time: *"shoulda shipped, mate."*

**→ Grab your seat now: weekendmvp.app/shipable**

Doors close when we go live.
...
That's how long until we go live and the doors shut for good.
