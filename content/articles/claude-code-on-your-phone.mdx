...
- **1. Don't start a project from scratch on your phone.** — Initial scaffolding (creating folders, picking the stack, writing CLAUDE.md) is much faster on a real keyboard. Phones are for projects you've already started — pick [what to build with Claude](/build-with/claude) at your desk first, then take the rest mobile.
