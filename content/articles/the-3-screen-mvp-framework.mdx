...
title: "The 3-Screen MVP: Ship This Weekend"
...
wordCount: 876
readMinutes: 4
heroAlt: "Three blank index cards in a row on a dark surface, lavender light on the leftmost card"
---
...
Does this work for B2B? Yes—often better. One workflow, one buyer, one PDF or email out. Complexity hides in sales, not in UI. What about mobile? Same three states—just responsive. Don't add a fourth "explainer" carousel to avoid building the loop.
