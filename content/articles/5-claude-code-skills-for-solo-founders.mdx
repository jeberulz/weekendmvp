...
If you don't have Claude Code installed yet, start with the [non-technical founder's guide](/articles/claude-code-for-non-technical-founders). Not sure what to build first? Browse [Claude AI project ideas](/build-with/claude) for inspiration.
